...
| Local AI | Experimental | See [local model recommendations](local-ai-models.md). Current picks: Pi/Ubuntu `qwen2.5:1.5b`, Steam Deck `qwen3:1.7b`, Bazzite RTX 2070 `mistral:7b`, RTX 4070 desktop `gemma4:e4b`. |
