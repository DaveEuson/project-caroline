# Project: Caroline v0.3.0-beta.5

Public beta polish build for Project: Caroline host/kiosk, WSL, Steam Deck/Bazzite testing, and Project: Caroline Companion App setup workflows.
...
- Companion app release: `companion-v0.1.13`.
- Release name: Project: Caroline Companion App (PCA) v0.1.13.
- Recommended for the new Host Setup Hub, privacy controls, document review, Screen Ask, and companion transcript fixes.

## Known Issues

- OpenRouter with Gemini 2.5 Flash Lite is the recommended public beta AI path for polished replies, low cost, and lower device load.
