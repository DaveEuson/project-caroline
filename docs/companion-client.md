...
| macOS Apple Silicon | `MacAppleSilicon_Project.Caroline.Companion_0.1.13_aarch64.dmg` |
| macOS Intel | `MacIntel_Project.Caroline.Companion_0.1.13_x64.dmg` |

If the chat fills with repeated **Task list updated.** or **Calendar updated.** messages, update to `companion-v0.1.13` or newer. Older companion builds displayed raw task/calendar sync WebSocket updates as normal chat messages.
